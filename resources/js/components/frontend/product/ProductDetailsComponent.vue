        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 sm:col-6 lg:col-5 lg:pl-10" style="direction: rtl">
                    <h2 class="text-3xl sm:text-4xl font-bold capitalize mb-1">PRADA</h2>
                    <h4 class="text-2xl sm:text-3xl mb-5">عدسات شهرية من لنس مي - عبوة من عدستين</h4>
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="flex justify-between items-center px-4">
                            <p class="text-lg font-semibold" dir="rtl">اختر لون العدسات</p>
                            <p class="text-base font-normal" dir="rtl">متوفر بي 24 لون</p>
                        </div>
                        <swiper
                            :slides-per-view="8"
                            :space-between="10"
                    ...
                    <div class="flex border-b gap-5" style="justify-content: center;">
                        <div
                            ...
                            style="width: 50%;"
                        >
                            <button class="focus:outline-none">بدون مقاس</button>
                        </div>
                        <div
                            ...
                            style="width: 50%;"
                        >
                            <button class="focus:outline-none"> بمقاس</button>
                        </div>
                    </div>
                    <!-- Content -->
                    ...
                    <div class="mt-8 px-8" v-else-if="currentTab === 'بمقاس'">
                        <div class="col-6 p-0 gap-2">
                            <label class="block mb-2 text-right font-medium text-gray-700">مجال العدسي</label>
                    ...
                    <div class="flex flex-wrap items-center gap-8 mb-10">
                        ...
                        >
                            ...
                            <span class="whitespace-nowrap font-bold">اضف الي العربه</span>
                        ...
                        <div id="tab_details" class="tab-div active p-4 sm:p-8 sm:pt-6 border-t border-[#D9DBE9]">
                            <div class="flex flex-col gap-8 p-6">
                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">حجم</span>
                                    <span class="text-lg font-medium text-gray-400">53/135/22</span>
                                </div>

                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">الخامة</span>
                                    <span class="text-lg font-medium text-gray-400">اسيتات</span>
                                </div>

                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">علامة المصمم</span>
                                    <span class="text-lg font-medium text-gray-400">ميو ميو</span>
                                </div>

                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">نوع الاطار</span>
                                    <span class="text-lg font-medium text-gray-400">اطار كامل</span>
                                </div>

                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">شكل الإطار</span>
                                    <span class="text-lg font-medium text-gray-400">كات اي</span>
                                </div>

                                <div class="flex justify-between items-center">
                                    <span class="text-lg font-medium text-gray-900">Sku</span>
                            ...
                            <div class="flex flex-col sm:flex-row p-4 sm:p-8 gap-5" style="direction: ltr">
                                ...
                                <div class="sm:pl-6 flex flex-col justify-center w-full sm:w-1/2">
                                    <p class="text-lg font-medium text-right text-gray-900 leading-relaxed" dir="rtl">
                                        ...
                                        تجسد مجموعة نظارات ميو ميو ببراعة جوهر العلامة التجارية الفني المتقدم. مشهورة بجمالياتها المبتكرة والجذابة،
                                        تجمع تصاميم النظارات بين أشكال جريئة وتفاصيل غير متوقعة.
                                    </p>
                                </div>
                            </div>
                        </div>
